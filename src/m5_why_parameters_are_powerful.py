...
def main():
    ...
    # -------------------------------------------------------------------------
    # even_better_draw_circles(rg.Point(100, 50), 3, 7, 'green', 5)
    # even_better_draw_circles(rg.Point(-200, 0), 15, 2, 'red', 50)
    one = rg.SimpleTurtle()
    one.pen = rg.Pen('red', 5)
    two = rg.SimpleTurtle()
    two.pen = rg.Pen('green', 5)
    three = rg.SimpleTurtle()
    three.pen = rg.Pen('blue', 5)
    one.pen_up()
    two.pen_up()
    three.pen_up()
    one.go_to(rg.Point(25, 0))
    one.pen_down()
    one.draw_circle(100)
    two.go_to(rg.Point(100, -50))
    two.pen_down()
    two.draw_circle(200)
    three.go_to(rg.Point(-200, -100))
    three.pen_down()
    three.draw_circle(250)
    window.update()
...
def even_better_draw_circles(point, x, max, color, thiccness):
    ...
    for k in range(1, max):  # k becomes 1, 2, 3, ... 10
