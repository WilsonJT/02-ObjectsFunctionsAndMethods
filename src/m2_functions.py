...
def main():
    ...
    turtle_maker('Koopa', 'green', 10)
    turtle_maker('Paratroopa', 'red', 3)
    """
...
#
###############################################################################
def turtle_maker(name, color, thiccness):
    name = rg.SimpleTurtle()
    name.pen = rg.Pen(color, thiccness)
    print('Name: ', name)
    print('Color: ', color)
    print('Thiccness: ', thiccness)
